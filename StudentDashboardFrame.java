...
public class StudentDashboardFrame extends JFrame {
    ...
    private JsonCourseDataBaseManager db2;
    ...
    public StudentDashboardFrame(Student student) {
        ...
        db2 = new JsonCourseDataBaseManager();
        setupUI();
    ...
    private void EnrollCourse() {
        ...
        if (!"Enrolled".equals(enrollment)) {
            // Get the course
            course temp = db2.getCourseById(Integer.parseInt(courseId));

            if (temp != null) {
                String studentId = student.getUserId(); // keep as String
